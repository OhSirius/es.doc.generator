...
namespace BG.Infrastructure.Morphology
{
    public class Declension: IDeclension
    {
        ...
        public string GetDeclension(string FIO, DeclensionCase declensionCase)
        {
        ...
        /// <param name="z5"></param>
        /// <returns></returns>
        public string GetDeclension(string FIO, DeclensionCase declensionCase /*=2*/, DeclensionGender gender /*=3*/, /*Знач*/ string part /*="123"*/, int z5 /*=1*/)
        {

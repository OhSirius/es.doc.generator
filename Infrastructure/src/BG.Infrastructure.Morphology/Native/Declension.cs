...
namespace BG.Infrastructure.Morphology.Native
{
    public class Declension: IDeclension
    {
        ...
        /// <returns></returns>
        private static string _declension(string FIO, int declensionCase /*=2*/, string gender /* = "*" */, int part /* =0 */)
        {
        ...
        {
            return GetPersonNameDeclension(FIO, declensionCase, DeclensionGender.NotDefind, "123", 1);
        }
        ...
        /// <param name="z5"></param>
        /// <returns></returns>
        public string GetPersonNameDeclension(string FIO, DeclensionCase declensionCase /*=2*/, DeclensionGender gender /*=3*/, /*Знач*/ string part /*="123"*/, int z5 /*=1*/)
        {
            ...
            if (z5 < 4)
            {
                ...
                return GetPersonNameDeclension(_FIO, declensionCase, gender, _part, z5 + 1);
            }
            else
            {
                return part;
        ...
        public DeclensionGender DefineDeclensionGender(string FIO)
        {
            string z6 = LCase(Right(RTrim(FIO), 4));
            string z7 = Right(z6, 1);
            var gender = z6 == "оглы" || z6 == "кызы" ? DeclensionGender.MasculineGender : DeclensionGender.NotDefind;
            if (gender == DeclensionGender.NotDefind)
            {
                var strGender = Mid("ча" + z7, 3, 1);
                gender = strGender == "а" ? DeclensionGender.FeminineGender : DeclensionGender.MasculineGender; 
            }
            return gender;
        }
        ...
        {
            return DefineDeclensionGender(FIO);
        }
